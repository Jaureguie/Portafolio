...
const typed = new Typed('.typed',{
    strings: ['Ing. en Comunicaciones y Electrónica',
...
window.addEventListener('click', e=>{
    if(menu.classList.contains('spread') && e.target != menu && e.target != hamburger || menu.classList.contains('spread') && screen.width <800  && e.target != hamburger )
    {
        menu.classList.toggle("spread")
    }
})